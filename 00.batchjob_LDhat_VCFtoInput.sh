...
#SBATCH -J VCFtoLDhatInput      # sensible name for the job

cat $0
# load up the correct modules, if require
. /etc/profile.d/modules.sh
module load Miniconda3/4.7.10 BCFtools/1.6-intel-2017.02 vcftools/0.1.14 HTSlib/20160107-intel-2017.02-PacBio samtools/1.4
# launch the code
